		...
		stages {
			...
			stage('Deploy: ProGet') {
				steps {
					...
					bat 'powershell.exe -Command "Import-Module \'C:\\Program Files\\WindowsPowerShell\\Modules\\PowerShellGet\' -WarningAction Ignore; Install-PackageProvider -Name "Nuget" -RequiredVersion "2.8.5.216" -Force"'
					bat 'powershell.exe -Command "Get-PackageProvider | select -ExpandProperty Name"'
